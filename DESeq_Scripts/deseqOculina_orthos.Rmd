...
ggsave(deg_barplot, file = "/Users/hannahaichelman/Dropbox/BU/Host_Buffering/MPCC_2018/Sym_analyses/plots/orthos_deg_barplot_newcounts_filtered.pdf", width=5, height=4, units=c("in"), useDingbats=FALSE)
```
